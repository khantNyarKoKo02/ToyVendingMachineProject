...
public class Main {
    ...
    public static void saveRecord(String data, String fileName) {
        try (FileWriter writer = new FileWriter(fileName, true)) {  // No path, just the file name
    ...
    public static void readRecords(String fileName) {
        try (BufferedReader reader = new BufferedReader(new FileReader(fileName))) {  // No path, just the file name
            String line;
